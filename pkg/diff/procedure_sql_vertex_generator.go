...
func newProcedureSqlVertexGenerator() sqlVertexGenerator[schema.Procedure, procedureDiff] {
...
func (p procedureSQLVertexGenerator) Delete(s schema.Procedure) (partialSQLGraph, error) {
	// Stored procedure dependencies can't be tracked...so they can either be deleted first or last. We will delete
	// last on the off-chance some function depends on this procedure.
