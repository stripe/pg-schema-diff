...
var partitionedIndexAcceptanceTestCases = []acceptanceTestCase{
	...
	},
	{
		...
		expectedPlanDDL: []string{
			...
			"ALTER TABLE \"public\".\"foobar\" ADD CONSTRAINT \"pgschemadiff_tmpnn_EBESExQVTheYGRobHB0eHw\" CHECK(\"id\" IS NOT NULL) NOT VALID",
			"ALTER TABLE \"public\".\"foobar\" VALIDATE CONSTRAINT \"pgschemadiff_tmpnn_EBESExQVTheYGRobHB0eHw\"",
			"ALTER TABLE \"public\".\"foobar\" ADD CONSTRAINT \"pgschemadiff_tmpnn_ICEiItQlRieoKSorLC0uLw\" CHECK(\"foo\" IS NOT NULL) NOT VALID",
			"ALTER TABLE \"public\".\"foobar\" VALIDATE CONSTRAINT \"pgschemadiff_tmpnn_ICEiItQlRieoKSorLC0uLw\"",
			...
			"ALTER TABLE \"public\".\"foobar\" DROP CONSTRAINT \"pgschemadiff_tmpnn_ICEiItQlRieoKSorLC0uLw\"",
