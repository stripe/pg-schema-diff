...
var partitionedIndexAcceptanceTestCases = []acceptanceTestCase{
	...
	},
	{
		...
		expectedPlanDDL: []string{
			"ALTER INDEX \"public\".\"some_idx\" RENAME TO \"pgschemadiff_tmpidx_some_idx_ICEiIyQlRieoKSorLC0uLw\"",
			"ALTER TABLE \"public\".\"foobar\" ADD CONSTRAINT \"pgschemadiff_tmpnn_AAECAwQFRgeICQoLDA0ODw\" CHECK(\"id\" IS NOT NULL) NOT VALID",
			"ALTER TABLE \"public\".\"foobar\" VALIDATE CONSTRAINT \"pgschemadiff_tmpnn_AAECAwQFRgeICQoLDA0ODw\"",
			"ALTER TABLE \"public\".\"foobar\" ADD CONSTRAINT \"pgschemadiff_tmpnn_EBESExQVRheYGRobHB0eHw\" CHECK(\"foo\" IS NOT NULL) NOT VALID",
			...
			"DROP INDEX \"public\".\"pgschemadiff_tmpidx_some_idx_ICEiIyQlRieoKSorLC0uLw\"",
		},
	},
	{
