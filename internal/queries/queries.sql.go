...
SELECT pg_proc.proname::TEXT        AS func_name,
...
FROM pg_catalog.pg_constraint
     ...
     ON pg_constraint.confrelid = foreign_table_c.oid
         ...
         INNER JOIN pg_catalog.pg_class as index_c ON pg_constraint.conindid = index_c.oid
...
FROM pg_catalog.pg_class AS c
         ...
         LEFT JOIN pg_catalog.pg_constraint AS con ON (con.conindid = c.oid AND con.contype IN ('p', 'u', NULL))
         LEFT JOIN
